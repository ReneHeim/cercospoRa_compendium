...
roi <- sf::st_read(here::here("reproducibility_raw_data", "Field_perimeter.gpkg"))  # expects a GPKG with field polygon
...
for(platform_ID in platforms){
  ...
  # find list of images
  folder_directory <- file.path(here::here("reproducibility_raw_data"), platform)
