...
### Read in data
```{r read_data}
cclo <- fread("../output/2025-12-08_fulldf_cc_cercospoRa.csv")[, "data" := "canopy_closure"]
eeeo <- fread("../output/2025-12-08_fulldf_eo_cercospoRa_sus5.csv")[, "data" := "epidemic_onset"]
```
